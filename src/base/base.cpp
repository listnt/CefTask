...
Matrix4x4 computePerspectiveMatrix(float fovInRads, float aspectRatio,
...
Matrix4x4 inverse(Matrix4x4 m) {
  ...
  */
  ...
  Matrix4x4 Inv;
  Inv.m[0][0] =
      m.m[3][1] * t9_14_13_10 + m.m[3][2] * t13_6_5_14 + m.m[3][3] * t5_10_9_6;
  Inv.m[0][1] =
      m.m[3][1] * t12_10_8_14 + m.m[3][2] * t4_14_12_6 + m.m[3][3] * t8_6_4_10;
  Inv.m[0][2] =
      m.m[3][1] * t8_13_12_9 + m.m[3][2] * t12_5_4_13 + m.m[3][3] * t4_9_8_5;
  Inv.m[0][3] = m.m[2][1] * (-t8_13_12_9) + m.m[2][2] * (-t12_5_4_13) +
                m.m[2][3] * (-t4_9_8_5);
  Inv.m[1][0] = m.m[3][0] * (-t9_14_13_10) + m.m[3][2] * t1_14_13_2 +
                m.m[3][3] * t9_2_1_10;
  Inv.m[1][1] = m.m[3][0] * (-t12_10_8_14) + m.m[3][2] * t12_2_0_14 +
                m.m[3][3] * t0_10_8_2;
  Inv.m[1][2] =
      m.m[3][0] * (-t8_13_12_9) + m.m[3][2] * t0_13_12_1 + m.m[3][3] * t8_1_0_9;
  Inv.m[1][3] = m.m[2][0] * t8_13_12_9 + m.m[2][2] * (-t0_13_12_1) +
                m.m[2][3] * (-t8_1_0_9);
  Inv.m[2][0] = m.m[3][0] * (-t13_6_5_14) + m.m[3][1] * (-t1_14_13_2) +
                m.m[3][3] * t1_6_5_2;
  Inv.m[2][1] = m.m[3][0] * (-t4_14_12_6) + m.m[3][1] * (-t12_2_0_14) +
                m.m[3][3] * t4_2_0_6;
  Inv.m[2][2] = m.m[3][0] * (-t12_5_4_13) + m.m[3][1] * (-t0_13_12_1) +
                m.m[3][3] * t0_5_4_1;
  Inv.m[2][3] =
      m.m[2][0] * t12_5_4_13 + m.m[2][1] * t0_13_12_1 + m.m[2][3] * (-t0_5_4_1);
  Inv.m[3][0] = m.m[3][0] * (-t5_10_9_6) + m.m[3][1] * (-t9_2_1_10) +
                m.m[3][2] * (-t1_6_5_2);
  Inv.m[3][1] = m.m[3][0] * (-t8_6_4_10) + m.m[3][1] * (-t0_10_8_2) +
                m.m[3][2] * (-t4_2_0_6);
  Inv.m[3][2] = m.m[3][0] * (-t4_9_8_5) + m.m[3][1] * (-t8_1_0_9) +
                m.m[3][2] * (-t0_5_4_1);
  Inv.m[3][3] =
      m.m[2][0] * t4_9_8_5 + m.m[2][1] * t8_1_0_9 + m.m[2][2] * t0_5_4_1;

  auto det = m.m[3][0] * (m.m[2][1] * (-t8_13_12_9) +
                          m.m[2][2] * (-t12_5_4_13) + m.m[2][3] * (-t4_9_8_5)) +
             m.m[3][1] * (m.m[2][0] * t8_13_12_9 + m.m[2][2] * (-t0_13_12_1) +
                          m.m[2][3] * (-t8_1_0_9)) +
             m.m[3][2] * (m.m[2][0] * t12_5_4_13 + m.m[2][1] * t0_13_12_1 +
                          m.m[2][3] * (-t0_5_4_1)) +
             m.m[3][3] * (m.m[2][0] * t4_9_8_5 + m.m[2][1] * t8_1_0_9 +
                          m.m[2][2] * t0_5_4_1);
...
Vector3f Lerp(Vector3f a, Vector3f b, double t) {
  return Vector3f(a.x + (b.x - a.x) * t, a.y + (b.y - a.y) * t,
                  a.z + (b.z - a.z) * t);
}
...
Vector4f ZIndexToColor4f(int zIndex) {
  ...
  return {static_cast<GLfloat>(r / 255.0), static_cast<GLfloat>(g / 255.0),
          static_cast<GLfloat>(b / 255.0), static_cast<GLfloat>(a / 255.0)};
}

std::vector<Vector2f> CreateCircle(Vector2f center, float radius,
                                   int segments) {
  std::vector<Vector2f> points;
  points.reserve(3 * segments);
  for (int i = 0; i < segments; i++) {
    points.push_back(
        Vector2f(center.x + radius * cos(2 * M_PI * (i) / segments),
                 center.y + radius * sin(2 * M_PI * (i) / segments)));
    points.push_back(
        Vector2f(center.x + radius * cos(2 * M_PI * (i + 1) / segments),
...
Matrix4x4 computeOrthoMatrix(float left, float right, float bottom, float top,
                             float near, float far) {
